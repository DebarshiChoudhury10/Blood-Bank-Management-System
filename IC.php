				...
				<div class="na"><h3> <?php if (isset($_SESSION['user_name']))
{
	...
	<section id="recorda" class="serad">
		...
		<div class="ser-paras">
			<h2 class="text-center text-big">Issue Complaint</h2>
			<div class="container">
  				<form id='managebb' method="post">
    					...
    					<div class="row">
      						<div class="col-25">
        						<label class="lab" for="subject">Issue/Report</label>
      						</div>
      						<div class="col-75">
        						<textarea id="blooda" name="blooda" placeholder="Write Your Issues..." style="height:400px"></textarea>
      						</div>
    					</div>
    					<div class="row addbt">
      						<button type="submit" name="addbtn" id="addbtn" class="addbtn" value="Add">REPORT</button>
    					</div>
  				</form>
			</div>
		</div>
